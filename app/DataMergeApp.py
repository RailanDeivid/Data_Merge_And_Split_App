...
st.markdown("<p class='contact-me'>💡 Desenvolvido por Railan Deivid<br>Contate-me via <a href='https://www.linkedin.com/in/railandeivid/' target='_blank'>LinkedIn</a> <img src='https://cdn-icons-png.flaticon.com/512/174/174857.png' class='linkedin-icon'></p>", unsafe_allow_html=True)
